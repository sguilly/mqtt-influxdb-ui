...
module.exports = function (app) {
    ...
    var module = {
        ...
        delete: function (id, query, cb) {
            ...
            app.clientRedis.del('lastTopicDate:' + id, function (err, count) {
        ...
        read: function (query, cb) {
            ...
            app.clientRedis.keys(query + ':*', function (err, replies) {
        ...
        readById: function (id, query, cb) {
            ...
            app.clientRedis.get('clientLog:published:' + id, function (err, reply) {
